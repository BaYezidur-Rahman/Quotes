...
public class hamid extends AppCompatActivity implements View.OnClickListener {
    private TextView text1,text2,text3,text4,text5,text6,text7,text8;
    private ImageView copy1,copy2,copy3,copy4,copy5,copy6,copy7,copy8;
    private ImageView share1,share2,share3,share4,share5,share6,share7,share8;
    private ImageView backBtn,optionBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hamid);
        ...
        text1 =  findViewById(R.id.hamidtext1);
        text2 =  findViewById(R.id.hamidtext2);
        text3 =  findViewById(R.id.hamidtext3);
        text4 =  findViewById(R.id.hamidtext4);
        text5 =  findViewById(R.id.hamidtext5);
        text6 =  findViewById(R.id.hamidtext6);
        text7 =  findViewById(R.id.hamidtext7);
        text8 =  findViewById(R.id.hamidtext8);


        copy1 =  findViewById(R.id.hamidcopy1);
        copy2 =  findViewById(R.id.hamidcopy2);
        copy3 =  findViewById(R.id.hamidcopy3);
        copy4 =  findViewById(R.id.hamidcopy4);
        copy5 =  findViewById(R.id.hamidcopy5);
        copy6 =  findViewById(R.id.hamidcopy6);
        copy7 =  findViewById(R.id.hamidcopy7);
        copy8 =  findViewById(R.id.hamidcopy8);


        share1 =  findViewById(R.id.hamidshare1);
        share2 =  findViewById(R.id.hamidshare2);
        share3 =  findViewById(R.id.hamidshare3);
        share4 =  findViewById(R.id.hamidshare4);
        share5 =  findViewById(R.id.hamidshare5);
        share6 =  findViewById(R.id.hamidshare6);
        share7 =  findViewById(R.id.hamidshare7);
        share8 =  findViewById(R.id.hamidshare8);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.optionButton){
            ...
            PopupMenu popupMenu = new PopupMenu(hamid.this,optionBtn);
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                ...
                if (item.getItemId()==R.id.emailButton){
                    try {
                        ...
                        intent.putExtra(Intent.EXTRA_SUBJECT,"Quotes problems of imam gajjali(R.)");
                ...
                if (item.getItemId()==R.id.shareButton){
                    ...
                    Toast.makeText(hamid.this, "Share", Toast.LENGTH_SHORT).show();
                }
                return true;
            });
            popupMenu.show();
        ...
        if (v.getId()==R.id.hamidcopy1){
            ClipboardManager clipboardManager = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
            ClipData clipData = ClipData.newPlainText("TextView",text1.getText().toString());
            assert clipboardManager!=null;
            clipboardManager.setPrimaryClip(clipData);

            Toast.makeText(hamid.this, "কপি করা হয়েছে", Toast.LENGTH_SHORT).show();
        }

        if (v.getId()==R.id.hamidshare1){
